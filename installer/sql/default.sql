DROP TABLE IF EXISTS  `$_settings`, `$_sites`, `{PREFIX}migrations`;
...
INSERT INTO `$_settings` (`slug`, `value`, `default`) VALUES 
...
INSERT INTO `{PREFIX}users` (`id`, `email`, `password`, `salt`, `group_id`, `ip_address`, `active`, `activation_code`, `created_on`, `last_login`,`io_stamp`, `username`, `forgotten_password_code`, `remember_code`) VALUES
    (1,'{EMAIL}', '{PASSWORD}', '{SALT}', 1, '', 1, '', {NOW}, {NOW},{NOW}, '{USER-NAME}', NULL, NULL);
	
-- command split --


DROP TABLE IF EXISTS `{PREFIX}users_profiles`;

-- command split --

CREATE TABLE IF NOT EXISTS `{PREFIX}users_profiles` (
...
INSERT INTO `{PREFIX}users_profiles` (`id`, `user_id`, `first_name`, `last_name`, `display_name`, `company`, `lang`, `bio`, `dob`, `gender`, `phone`, `mobile`, `address_line1`, `address_line2`, `address_line3`, `postcode`, `updated_on`) VALUES
