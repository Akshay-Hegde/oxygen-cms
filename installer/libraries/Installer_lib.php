...
class Installer_lib
{
	...
	/**
	 * Install the OxygenCMS database and write the database.php file
	 *
	...
	public function install($data)
	{
		...
		//add site to the //$sites database table
		mysql_query(sprintf(
			'INSERT INTO `$_sites` (name, ref, domain, created_on, throttle, type ) VALUES ("Default Site", "%s", "%s", "%s", 0 , "park");',
			$data['site_ref'],
