...
#region user Params
    ...
    /** 
     * The min PHP version OxygenCMS will support
     * previously was: '5.3.9'
     */
    $phpVersion = '5.4.16';
...
if ($php && $databaseDriver && $zlib && $curl && $mcrypt && $gd) {
    echo "OxygenCMS has everything it needs!!\n";
    echo "</pre>";
    exit(0);
} else {
    echo "OxygenCMS DOES NOT have everything it needs. Please contact your system administrator.\n";
    echo "</pre>\n";
    exit(1);
}
