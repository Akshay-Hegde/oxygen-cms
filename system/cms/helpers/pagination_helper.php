...
if ( ! function_exists('create_pagination'))
{
	 ...
	 */
	function create_pagination($uri, $total_rows, $limit = null, $uri_segment = null, $full_tag_wrap = true)
	{
		$ci = & get_instance();
		$ci->load->library('pagination');

		//assume its the last segment, before it was 4, this is not relevant to all apps
		$uri_segment = ($uri_segment==null)?$ci->uri->total_segments():$uri_segment;
