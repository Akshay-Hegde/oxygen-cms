...
if (!function_exists('index_uri')) 
{
	...
	*/
	function index_uri()
	{
		if (strpos(uri_string(), get_instance()->router->method) !== false) {
			return trim(substr(uri_string(), 0, strpos(uri_string(), get_instance()->router->method)), '/');
		}
		return uri_string();
	}
}
