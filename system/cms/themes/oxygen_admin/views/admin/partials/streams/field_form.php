...
<div class="field_form_container">


			<label for="field_name">
				<?php echo lang('streams:label.field_name');?> <span>*</span>
			</label>
			...
			<div class="input">
				<?php
					...
					{
						echo form_input('field_name', $field->field_name, 'class="form-control" maxlength="60" id="field_name" autocomplete="off"');
					}
		...
		<?php if (property_exists($field, 'field_slug')): ?>
			...
			<div class="input"><?php echo form_input('field_slug', $field->field_slug, 'class="form-control" maxlength="60" id="field_slug"'); ?></div>
		...
		<?php if (property_exists($field, 'is_required')): ?>
			...
			<div class="input"><?php echo form_checkbox('is_required', 'yes', $is_required, 'class="" id="is_required"');?></div>
		...
		<?php if (property_exists($field, 'is_unique')): ?>
			...
			<div class="input"><?php echo form_checkbox('is_unique', 'yes', $is_unique, 'class="" id="is_unique"'); ?></div>
		...
		<?php if (property_exists($field, 'instructions')): ?>
			...
			<div class="input"><?php echo form_textarea('instructions', $field->instructions, 'class="form-control" id="field_instructions"');?></div>
		...
		<?php if ($allow_title_column_set): ?>
			...
			<div class="inputs"><?php echo form_checkbox('title_column', 'yes', $title_column_status, 'class="form-control" id="title_column"');?></div>
		...
		<div class="input"><?php echo form_dropdown('field_type', $field_types, $field->field_type, 'class="form-control" data-placeholder="'.lang('streams:choose_a_field_type').'" id="field_type"'); ?></div>
		...
		<div id="parameters">
			...
			if( $method == "edit" or isset($current_type->custom_parameters) ): 
				...
				if( isset($current_type->custom_parameters) ):
					...
					foreach( $current_type->custom_parameters as $param ):
						...
						echo $this->load->view('streams/extra_field', $data, TRUE);
		...
		<?php if ($cancel_uri): ?>
		<a href="<?php echo site_url($cancel_uri); ?>" class="btn btn-flat btn-default"><?php echo lang('buttons:cancel'); ?></a>
	<?php endif; ?>
	</div>
