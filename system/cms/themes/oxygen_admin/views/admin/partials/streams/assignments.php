...
<?php if ($assignments): ?>
    ...
    <table class="table table-list" border="0" cellspacing="0">
		<thead>
			<tr>	
				<th></th>
					...
					<?php
						...
						if (isset($buttons))
						{
							foreach($buttons as $button)
							{
								...
								$class = (isset($button['confirm']) and $button['confirm']) ? 'btn btn-flat bg-red confirm' : 'btn btn-flat bg-blue';
								...
								$all_buttons[] = anchor(str_replace ( '-assign_id-',  $assignment->assign_id,  $button['url'] ), $button['label'], $title.' class="'.$class.'"');
							}
						}
