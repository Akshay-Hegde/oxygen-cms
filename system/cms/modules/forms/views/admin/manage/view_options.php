    ...
    <div class="col-xs-12">
        <div class="box box-primary">
                ...
                <div class="box-header">
                  <h3 class="box-title"><?php echo lang('streams:view_options');?></h3>
                </div>
                <div class="box-body">
					...
					<?php echo form_open(uri_string(), 'class="crud"'); ?>
							...
							<a href="<?php echo site_url('admin/forms'); ?>" class="btn btn-flat btn-default"><?php echo lang('buttons:cancel'); ?></a>
