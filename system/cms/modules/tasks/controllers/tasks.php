...
class Tasks extends Public_Controller
{
	public function __construct()
	{
		...
		$this->template
			->append_css('module::tasks.css')
			->append_js('module::tasks.js');
	}
	...
	public function index($offset = 0)
	{
		...
		$items = $this->tasks_m->limit($limit)
			->offset($offset)
			->get_all();
		...
		$pagination = create_pagination('tasks', $this->tasks_m->count_all(), $limit, 2);
