...
class Admin_fields extends Admin_Controller {
	...
	public function index()
	{
		...
		$hidden = []; //array('first_name', 'last_name')
	...
	public function create()
	{
		...
		$this->streams->cp->field_form('users_profiles', 'users', 'new', 'admin/users/fields', null, array(), true, $extra);
	}
	...
	public function edit()
	{
		...
		$this->streams->cp->field_form('users_profiles', 'users', 'edit', 'admin/users/fields', $assign_id, array(), true, $extra);
	}
}