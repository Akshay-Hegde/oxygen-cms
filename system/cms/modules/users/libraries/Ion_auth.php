...
class Ion_auth
{
	 ...
	 * @author Mathew
	 **/
	public function register($username, $password, $email, $group_id = null, $additional_data = array(), $group_name = false,$force_send_email = 'auto')
	{
		...
		if ($id !== false)
		{
			...
			if(($force_send_email == 'auto') OR ($force_send_email == 'yes'))
			{
