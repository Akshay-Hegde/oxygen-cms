...
class User_m extends MY_Model
{
	...
	public function get_all()
	{
		$this->db
			...
			->join('users_groups g', 'g.id = users.group_id')
			->join('users_profiles', 'users_profiles.user_id = users.id', 'left')
			->group_by('users.id');
	...
	public function count_by($params = array())
	{
		$this->db->from($this->_table)
			->join('users_profiles', 'users.id = users_profiles.user_id', 'left');
		...
		if ( ! empty($params['name']))
		{
			$this->db
				...
				->or_like('users_profiles.first_name', trim($params['name']))
				->or_like('users_profiles.last_name', trim($params['name']));
		}
