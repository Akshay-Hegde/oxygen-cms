...
$lang['settings:site_lang_desc']				= 'The native language of the EOL, used to choose templates of e-mail notifications, contact form, and other features that should not depend on the language of a user.';
...
$lang['settings:mail_smtp_host_desc']			= 'The host name of your smtp server. For Gmail try <code>ssl://smtp.gmail.com</code>';

$lang['settings:mail_smtp_pass']				= 'SMTP password';
$lang['settings:mail_smtp_pass_desc']			= 'SMTP password.';

$lang['settings:mail_imap_pass']				= 'IMAP password';
$lang['settings:mail_imap_pass_desc']			= 'IMAP password.';


$lang['settings:mail_smtp_port'] 				= 'SMTP Port';
$lang['settings:mail_smtp_port_desc'] 			= 'SMTP port number. Leave blank for Google SMTP option (i.e for Gmail SSL try <code>465</code>).';

$lang['settings:mail_smtp_user'] 				= 'SMTP User Name';
$lang['settings:mail_smtp_user_desc'] 			= 'SMTP user name. In most cases this is just the account email address <code>name@yourdomain.com</code>';
...
$lang['settings:public_theme']					= 'Default Theme';
$lang['settings:public_theme_desc']			= 'Select the theme you want users to see by default.';
...
$lang['settings:ga_tracking_id']				= 'Google Tracking ID';
$lang['settings:ga_tracking_id_desc']			= 'Enter your Google Analytic Tracking ID to activate Google Analytics view data capturing. E.g: UA-19483569-6';
