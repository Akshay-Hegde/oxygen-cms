...
class Plugin_Files extends Plugin
{
	...
	public function folders()
	{
		...
		$files = ($include_files == 'yes')
			? get_instance()->file_m->where('folder_id', $parent)->order_by('sort')->get_all()
			: false;
	...
	private function _build_tag_location_url($type = '', $uri = '', $extras = [])
	{
		extract($extras);
	...
	private function _build_tag_location_path($type = '', $uri = '', $extras = [])
	{
		extract($extras);
