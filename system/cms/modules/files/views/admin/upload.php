      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <small>Drop files and images in the box below</small>
            </div>
            <div class="modal-body">
                <?php echo form_dropdown('filter_folder',$folders,$folder,'id="filter_folder"');?>

                <div style="border:dashed 5px #aaa;background:#fff;">
                    <!-- DROP ZONE -->
                    <div class="input dropzone" id="mydrop">
