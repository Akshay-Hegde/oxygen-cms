            ...
            <div class="box box-solid">
                  ...
                  <div class="box-body">
                            ...
                            <?php
                                ...
                                if(file_exists(FCPATH.'/system/cms/themes/oxygen_admin/img/file_types/'.str_replace('.','',$file->extension).'.png'))
                                {
                                    $icon_image_filename = site_url('system/cms/themes/oxygen_admin/img/file_types/'.str_replace('.','',$file->extension).'.png');
                                }
                                else
                                {
                                     switch($file->type) 
                                ...
                                <img class='img-responsive center-block' src='<?php echo $icon_image_filename;?>'>
                            </div>
            ...
            <div class="box box-solid">
                  ...
                  <div class="box-body">
                    ...
                    <li class="item">
                        <div class="product">
                            <a>Tag</a>
                            <input type="text" class="form-control" readonly=readonly value='{{noparse}} {{ files:file id="<?php echo $file->id;?>" }}{{/noparse}}'>
                        </div>
                    </li>
                    ...
                    <li class="item">
                        <div class="product">
                            <a>Link</a>
                            <input type="text" class="form-control" readonly=readonly value='{{noparse}}{{url:site}}files/download/<?php echo $file->id;?>{{/noparse}}'>
                        </div>
                    </li>

                    <li class="item">
                        <div class="product">
                            <a class="product-title" href="{{url:site}}files/download/<?php echo $file->id;?>">Download</a>
                            <input type="text" class="form-control" readonly=readonly value='{{url:site}}files/download/<?php echo $file->id;?>'>
                        </div>
                    </li>
                      ...
                      <li class="item">
                        Direct Access
                        <a><?php echo $file->direct_access;?></a>
                      </li>
