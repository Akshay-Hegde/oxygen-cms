...
class Installer_Files extends Component
{
	...
	public function install()
	{
		...
		$tables = array(
			'files' => array(
				...
				//which module created/manages this file
				'module' => array('type' => 'VARCHAR', 'constraint' => 100, 'default' => 'files'),
				'direct_access' => array('type' => 'TINYINT', 'constraint' => 1, 'default' => 1,),
			),
			'file_folders' => array(
				...
				'core' => array('type' => 'TINYINT', 'constraint' => 1, 'default' => 0,),
			),
		);
        ...
        $this->db->insert_batch('file_folders', $default_folders);
