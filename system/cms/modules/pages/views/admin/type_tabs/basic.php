				<div class='tab-pane active' id="page-layout-basic">
					...
					<fieldset>
							...
							<?php endif; ?>
								...
								<label for="theme_layout">Structure <span>*</span></label>
								<div class="input"><?php echo form_dropdown('theme_struct', [''=>'No structure'] + $theme_layouts_structs, $page_type->theme_struct ? $page_type->theme_struct : 'default'); ?></div>
