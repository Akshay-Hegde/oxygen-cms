    ...
    <table class="table-list">
		...
		<?php foreach ($stream_fields as $stream_field):?>
			<tr>
				...
				<td class="actions">
					<?php echo anchor('admin/flows/assignments/edit_assignment/'.$stream_field->stream_id . '/'.$stream_field->assign_id, lang('streams:edit_assign'), 'class="button"'); ?>
					<?php echo anchor('admin/flows/assignments/remove_assignment/'.$stream_field->stream_id . '/'.$stream_field->assign_id, lang('streams:remove'), 'class="button confirm"'); ?>
				</td>
			</tr>
		<?php endforeach;?>
		</tbody>
...
<?php else: ?>
	...
	<?php echo lang('streams:start.before_assign');?> <?php echo anchor('admin/flows/fields/add', lang('streams:start.create_field_here'))?>.
