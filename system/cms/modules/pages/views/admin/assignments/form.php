		...
		<div class='col-xs-12'>
			<div class="box box-primary">
				<div class="box-header">
					<h3 class="box-title">
						<?php if( $method == 'new' ): ?>
							<a href="<?php echo site_url('admin/pages/types/view/'.$page_type->id); ?>"><?php echo $stream->stream_name;?></a> &rarr; <?php echo lang('streams:assign_field');?>
						<?php else: ?>
							<span><a href="<?php echo site_url('admin/pages/types/view/'.$page_type->id); ?>"><?php echo $stream->stream_name;?></a></span> &rarr; <?php echo lang('streams:edit_assign');?>
						<?php endif; ?>
					</h3>
				</div>
				<div class="box-body">
					...
					<div class="form_inputs">
						...
						<div class="float-right buttons">
							...
							<a href="<?php echo site_url('admin/flows/assignments/'.$stream->id); ?>" class="btn gray cancel"><?php echo lang('buttons:cancel'); ?></a>
						</div>
					...
					<?php else: ?>
						...
						<?php echo lang('streams:start.no_fields_to_assign');?> <?php echo anchor('admin/pages/types/fields/'.$page_type->id.'/new_field', lang('streams:start.create_field_here'))?>.
						</div>
