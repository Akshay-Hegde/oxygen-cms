...
class Streams_m extends MY_Model {
	...
	public function get_edit_validation($stream_slug)
	{
		// 1. Copy
		$validation = $this->streams_validation;

		// 2. Validation & Setup
		$validation[1]['rules'] .= '|stream_unique['.$stream_slug.']';
	
		return 	$this->streams_validation;
	}
