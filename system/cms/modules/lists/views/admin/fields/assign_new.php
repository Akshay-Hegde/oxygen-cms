            ...
            <div class="box-body">
				...
				<div class="form_inputs">
					...
					<div class="float-right buttons">
						<button type="submit" name="btnAction" value="save" class="btn btn-flat bg-blue">
							<span>
								<?php echo lang('buttons:save'); ?>
							</span>
						</button>	
						<a href="<?php echo site_url('admin/lists/admin_fields/listing/'.$stream->stream_slug); ?>" class="btn btn-default btn-flat">
				...
				<?php else: ?>
					...
					<div class="no_data">
					<?php echo lang('streams:start.no_fields_to_assign');?> <?php echo anchor('admin/lists/admin_fields/create/'.$stream->stream_slug, lang('streams:start.create_field_here'))?>.
					</div>
