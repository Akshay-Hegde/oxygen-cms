 ...
 */
class _Comments_m extends MY_Model
{
     ...
     */
  	public function get($id)
  	{
		return $this->db->select('c.*')
    		...
    		->join('users_profiles m', 'm.user_id = u.id', 'left')
	...
	public function delete_by_module($module='',$entry_key=null,$entry_id=null)
	{
		
		$this->db->where('module',$module);

		if($entry_key != null) {
			$this->db->where('entry_key',$entry_key);
		}
