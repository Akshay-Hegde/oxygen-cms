					...
					<td class="align-center buttons buttons-small">
						<?php if ($this->settings->moderate_comments): ?>
							<?php if ($comment->is_active): ?>
								<?php echo anchor('admin/comments/unapprove/'.$comment->id, lang('buttons:unapprove'), 'class="btn bg-red btn-flat confirm  deactivate"') ?>
							<?php else: ?>
								<?php echo anchor('admin/comments/approve/'.$comment->id, lang('buttons:approve'), 'class="btn btn-default btn-flat confirm activate"') ?>
							<?php endif ?>
						<?php endif ?>
					
						<?php echo anchor('admin/comments/edit/'.$comment->id, lang('global:edit'), 'class="btn btn-default btn-flat  edit"') ?>
						<?php echo anchor('admin/comments/delete/'.$comment->id, '<i class="fa fa-times"></i>', array('class'=>'btn bg-red btn-flat confirm')) ?>
						<?php //echo anchor('admin/comments/report/'.$comment->id, 'Report', array('class'=>'btn btn-default btn-flat  edit')) ?>
					</td>
				</tr>
			<?php endforeach ?>
		</tbody>
