...
class Admin extends Admin_Controller
{
	...
	public function index()
	{
		...
		//Get all other maintenance tasks
		$extra_maintenance_list = new stdClass();
		Events::trigger('maintenance_request',$extra_maintenance_list);
		...
		$this->template
			...
			->set('tables', $tables)
			->set('folders', $folders)
			->set('extra_maintenance', $extra_maintenance_list->items)
			->build('admin/items');
	}
