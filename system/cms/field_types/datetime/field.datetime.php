...
{	
	...
	public function form_output($data, $entry_id, $field)
	{
		...
		else
		{
			...
			$date_input .= form_dropdown($data['form_slug'].'_month', $months, $current_month,'class="form-control"');
			...
			$date_input .= form_dropdown($data['form_slug'].'_day', $days, $current_day,'class="form-control"');
			...
			$date_input .= form_dropdown($data['form_slug'].'_year', $years, $current_year,'class="form-control"');
		}
		...
		if ($data['custom']['use_time'] == 'yes')
		{
			...
			$date_input .= lang('global:at').'&nbsp;&nbsp;'.form_dropdown($data['form_slug'].'_hour', $hours, $date['hour'], 'class="form-control" style="min-width: 100px; width:100px;"');
			...
			$date_input .= form_dropdown($data['form_slug'].'_minute', $minutes, $date['minute'], 'class="form-control" style="min-width: 100px; width:100px;"');
			...
			$date_input .= form_dropdown($data['form_slug'].'_am_pm', $am_pm, $am_pm_current, 'class="form-control" style="min-width: 100px; width:100px;"');
		...
		return '<div class="input-group">'.$date_input.'</div>';
	}
