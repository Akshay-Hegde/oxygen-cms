...
class Field_relationship
{
	...
	public $custom_parameters		= [ 'choose_stream', 'link_uri' ];

    public $version = '1.0.0';

	public $author					= ['name'=>'Parse19', 'url'=>'http://parse19.com'];
	...
	public function pre_output($input, $data)
	{
		...
		if ($this->CI->uri->segment(1) == 'admin')
		{
			...
			{
				return '<a href="'.site_url('admin/lists/entries/view/'.$stream->id.'/'.$row['id']).'">'.$row[$title_column].'</a>';
			}
		}
		else
		{
