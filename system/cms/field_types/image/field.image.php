...
class Field_image
{
	...
	public $default_folder_slug 	= 'default_data_folder';
	...
	public function pre_save($input, $field, $stream, $row_id, $form_data)
	{
		...
		//Get the upload folder, if not found then use the system default.
		$upoad_folder = $field->field_data['folder'] || $this->default_folder_slug;

		$return = Files::upload($upoad_folder, null, $field->field_slug.'_file', $resize_width, $resize_height, $keep_ratio, $allowed_types);
