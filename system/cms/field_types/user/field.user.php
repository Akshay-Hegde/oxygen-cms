...
class Field_user
{
	...
	public function form_output($params, $entry_id, $field)
	{
		...
		return form_dropdown($params['form_slug'], $users, $params['value'], 'class="form-control" id="'.$params['form_slug'].'"');
	}
	...
	public function param_restrict_group($value = null)
	{
		...
		$db_obj = $this->CI->db->get('users_groups');
		...
		return form_dropdown('restrict_group', $groups, $value,"class='form-control'");
	}
