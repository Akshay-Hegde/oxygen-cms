...
class Field_wysiwyg
{
	...
	public function event()
	{
		...
		Asset::js('plugins/ckeditor/ckeditor.js');
		Asset::js('plugins/ckeditor/adapters/jquery.js');	

		$this->CI->type->add_misc($this->CI->load->view('fragments/wysiwyg',null,true));
	...
	public function form_output($data)
	{
		...
		//dump(form_textarea($options));die;
	...
	public function param_editor_type($value = null)
	{
		...
		[
			...
			'codedocs'	=> lang('streams:wysiwyg.codedocs')
		];
