 ...
 */
class Field_oxy_lang
{
	public $field_type_slug			= 'oxy_lang';
	
	public $db_col_type				= 'varchar';

	public $version					= '1.0.0';

	public $author					= array('name' => 'OxygenCMS', 'url' => 'http://www.oxygen-cms.com');
	...
	public function form_output($data)
	{
		...
		return form_dropdown($data['form_slug'], $languages, $data['value'],'class="form-control"');
	}
