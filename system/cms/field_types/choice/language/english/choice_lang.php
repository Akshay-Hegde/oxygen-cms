...
$lang['streams:choice.instructions'] 		= "Put each choice on one line. If you want a separate value for each choice, you can separate them by a colon (:).<pre>OxygenCMS\noxygen : OxygenCMS</pre>";
