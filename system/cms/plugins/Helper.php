...
class Plugin_Helper extends Plugin
{
	...
	public function gravatar()
	{
		...
		$options = ['size'=>$size,'rating'=>$rating,'url_only'=>$url_only,'style'=>$style];
		
		//gravatar-alt supports inline styles
		return gravatar_alt($email, $options);
