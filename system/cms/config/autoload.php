...
|	* oxycache and session is loaded by MY_Controller to allow the site_ref to be set
*/

$autoload['libraries'] = ['asset', 'database', 'template', 'parser'];
