...
class MY_Parser extends CI_Parser {
	 ...
	 * @return	string
	 */
	public function parse($template, $data = [], $return = false, $is_include = false, $streams_parse = [])
	{
	 ...
	 * @return	string
	 */
	public function parse_string($string, $data = [], $return = false, $is_include = false, $streams_parse = [])
	{
		return $this->_parse($string, $data, $return, $is_include, $streams_parse);
	}
	 ...
	 * @return	string
	 */
	protected function _parse($string, $data, $return = false, $is_include = false, $streams_parse = [])
	{
		// Start benchmark
