...
class Formation
{
	 ...
	 * @return	void
	 */
	public static function add_form($form_name, $attributes = [], $fields = [])
	{
	 ...
	 * @return	string
	 */
	public static function field($name, $properties = [], $form_name = null)
	{
		$return = '';
	 ...
	 * @return	string
	 */
	public static function open($form_name = null, $options = [])
	{
