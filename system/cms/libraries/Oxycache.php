 ...
 */
/**
 * strange bug not loading the ci delete files function, so we can define it here
 */
...
/**
 * Re-named for continuity of OxygenCMS branding.
 * Credits to Pyrocache  and the pyro team..
 *
 * Cache Class
 *
...
class Oxycache
{
	 ...
	 *
	 * <code>
	 * $this->oxycache->write($data, 'nav_title');
	 * $this->oxycache->write($links, 'nav_links');
	 * $this->oxycache->delete_group('nav_');
	 * </code>
	 *
