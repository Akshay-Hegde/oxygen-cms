...
class Asset {
	...
	*/
	...
	/**
	 * @returns the favicon link tag, 
	 * @todo, in future see if we can replace admin templates with {{theme:favicon}} similar to front-end theme
	 */
	public static function favicon($filename='favicon.ico', $type='image/x-icon')
	{
		$file = self::get_filepath($filename, 'img');
		return "<link rel='shortcut icon' type='{$type}' href='{$file}'>";
	}
