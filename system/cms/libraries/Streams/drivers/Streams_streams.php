...
class Streams_streams extends CI_Driver {
	 ...
	 */
	public function add_stream($stream_name, $stream_slug, $namespace, $prefix = null, $about = null, $extra = [])
	{
		// -------------------------------------
		// Validate Data
		// -------------------------------------
	 ...
	 * WIP
	 */
	public function duplicate_stream($stream)
	{
		return false;
		//dump($stream);die;
	 ...
	 * @return	object
	 */
	public function update_stream($stream, $namespace = null, $data = [])
	{	
		$str_id = $this->stream_id($stream, $namespace);
	 ...
	 * @return	object
	 */
	public function get_streams($namespace, $limit = null, $offset = 0, $hidden = null)
	{
		return $this->CI->streams_m->get_streams($namespace, $limit, $offset, $hidden);
	}
	 ...
	 */
	public function validation_array($stream, $namespace = null, $method = 'new', $skips = [], $row_id = null)
	{
		$str_id = $this->stream_id($stream, $namespace);
