...
class Streams_entries extends CI_Driver {
	 ...
	 * @return	array
	 */
	public function get_entries($params, $pagination_config = [], $skip_params = false)
	{
		$return = [];
	 ...
	 * @return	object
	 */
	public function insert_entry($entry_data, $stream, $namespace, $skips = [], $extra = [])
	{
	 ...
	 * @return	object
	 */
	public function update_entry($entry_id, $entry_data, $stream, $namespace, $skips = [], $extra = [], $include_only_passed = true)
	{
